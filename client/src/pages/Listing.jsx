                            ...
                            listing.imageUrls.map((url) => (
                                <SwiperSlide key={url}>
                                    {/* <div className="h-[500px]"
                                        ...
                                        <img src={url} alt="uimage" className=' object-cover h-screen w-full' />
                                </SwiperSlide>
                            ))
                        }
                    </Swiper>
...
{/* {currentUser && listing.userRef && listing.userRef !== currentUser._id && !contact && (
    <button
...
{contact && listing && listing.userRef && (
